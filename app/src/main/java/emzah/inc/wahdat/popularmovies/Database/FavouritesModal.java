...
public class FavouritesModal {
    ...
    @Ignore
    public FavouritesModal(String movieid,String voteAverage, String originalTitle, String posterPath, String backdropPath,String overview, String releaseDate,boolean favourite) {
        this.movieid=movieid;
